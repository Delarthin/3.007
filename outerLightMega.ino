...
void baseLightShow(){
  for (int i=0; i<lengthPinArray; i++){
    changeLights(analogPinArrayRevamped[i], baseColour);
  }
}
...
void waveBinLightShow(int timeDelay){
  for (int i=0; i<lengthPinArray; i++){
